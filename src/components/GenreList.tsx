...
import { HStack, Image, List, Text, ListItem, Spinner, Button, Heading } from '@chakra-ui/react';
    ...
    <>
      ...
      <List>
        {data.map(genre => <ListItem key={genre.id} paddingY='6px' >
          <HStack>
            <Image boxSize='32px' borderRadius={8} objectFit='cover' src={getCroppedImageUrl(genre.background_image)} />
